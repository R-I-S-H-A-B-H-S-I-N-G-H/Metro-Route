    ...
    <View style={styles.wholeView}>
      ...
      <View style={[styles.routeList]}>
        <View style={styles.listHeading}>
          ...
          >
            <Text style={styles.listHeadingText}>Stations : </Text>
            <Text style={styles.listHeadingText}>
              {routeList.length == 0 ? "--" : routeList.length}
            </Text>
          </View>
          ...
          >
            <Text style={styles.listHeadingText}>Fare : </Text>
            <Text style={styles.listHeadingText}>
              {routeList.length == 0 ? "--" : " ₹" + getFare(routeList.length)}
            </Text>
          </View>
        </View>
